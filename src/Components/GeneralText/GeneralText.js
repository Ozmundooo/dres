  ...
  return (
    <section
      ...
      <div className={'generaltext__content'}>
        <h3 className='generaltext__title' dangerouslySetInnerHTML={{__html: props.title}}></h3>
        <p className='generaltext__text'  dangerouslySetInnerHTML={{__html: props.text}}></p>
        { props.buttons ?
