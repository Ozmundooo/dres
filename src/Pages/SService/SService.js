  ...
  const services = [
    {
      ...
      subtitle:
        "Are your headlights losing their transparency, or turning dull in colour?",
      description:
        "Improve the overall value and safety of your vehicle, especially when driving at night. Having clear headlights will allow for more light to be emitted, letting you see better",
    ...
    },
    {
      ...
      subtitle:
        "A rock might have chipped the paint off your vehicle. This happens all the time ",
      description:
        "Wear & tear happens, but it can also be corrected. Through careful and detailed paint touch up, the Dre's team knows exactly how to bring your vehicle back to life",
      warrenty: "Warrenty: Details",
      link: "s",
    ...
    },
    {
      ...
      subtitle:
        "Protect your vehicle’s beauty with our Ceramic Coating Protection service",
      description:
        "This will keep your car looking like new, making your car glossy and cleaner due to mud and grime prevention",
      warrenty: "Warrenty: Details",
      link: "s",
    ...
    // ,
    {
      title: "DENT REPAIR",
      subtitle:
        "The PDR process is done through careful manipulation of the sheet metal from the backside with special tools",
      description:
      ...
      <section className={"generaltext"}>
        <div className={"generaltext__content"}>
          ...
          <p className="generaltext__text">
            Get your vehicle{" "}
            <span className="yellow">prepared for the season</span>
          </p>
        </div>
      </section>
      ...
      <section className={"generaltext"}>
        <div className={"generaltext__content"}>
          <h3 className="generaltext__title">
            <span className="yellow">VEHICLE WRAP</span>
          </h3>
          <p className="generaltext__text">
        ...
        <div className={"generaltext__content"}>
          <p className="generaltext__text">
            <span className="yellow">
              We work with{" "}
              <a href={ThreeMpdf} target="_blank" className="yellow">
                3M
              </a>
              ,{" "}
              <a href={Averypdf} target="_blank" className="yellow">
                Avery Denison
              </a>
              ,{" "}
              <a
                href="https://metrorestyling.com/pages/kpmf-vinyl-wrap"
                target="_blank"
                className="yellow"
              >
                KPMF
